...
using HorizontalAlignment = Capsium.Foundation.Graphics.HorizontalAlignment;

namespace AvaloniaCapsium.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            // since Avalonia and Capsium are both starting at the same time, we must wait
            // for CapsiumInitialize to complete before the output port is ready
